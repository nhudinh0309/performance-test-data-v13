...
This package is designed as a **class library** that references only `Umbraco.Cms.Core`, `Umbraco.Cms.Infrastructure`, and `Umbraco.Cms.Web.Common` (not the full Umbraco.Cms metapackage). This means:
