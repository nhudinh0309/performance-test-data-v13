...
public class MemberSeeder : BaseSeeder<MemberSeeder>
{
    ...
    protected override Task SeedAsync(CancellationToken cancellationToken)
    {
        ...
        SeedMembers(targetCount, prefix, password, groupNames, cancellationToken);

        return Task.CompletedTask;
    }

    private void SeedMembers(int targetCount, string prefix, string password, string[] groupNames, CancellationToken cancellationToken)
    {
    ...
    private void CreateFrontendPages()
    {
        ...
        try
        {
            ...
            var loginTemplate = CreateLoginTemplate(loginAlias, memberAreaAlias);
            var memberAreaTemplate = CreateMemberAreaTemplate(memberAreaAlias, loginAlias);

            // Create document types
            var loginDocType = CreateDocType(loginAlias, $"{prefix}Login", "icon-key", loginTemplate);
            var memberAreaDocType = CreateDocType(memberAreaAlias, $"{prefix}Area", "icon-user", memberAreaTemplate);
    ...
    private ITemplate CreateLoginTemplate(string loginAlias, string memberAreaAlias)
    {
...
<body>
    ...
    private ITemplate CreateMemberAreaTemplate(string memberAreaAlias, string loginAlias)
    {
...
<body>
    ...
    private IContentType CreateDocType(string alias, string name, string icon, ITemplate template)
    {
