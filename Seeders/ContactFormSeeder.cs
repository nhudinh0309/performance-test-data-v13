...
public class ContactFormSeeder : BaseSeeder<ContactFormSeeder>
{
    ...
    protected override Task SeedAsync(CancellationToken cancellationToken)
    {
        ...
        var textstringDataType = _dataTypeService.GetDataType(Constants.DataTypes.Textbox);
        var textareaDataType = _dataTypeService.GetDataType(Constants.DataTypes.Textarea);
        ...
        CreateSubmissionDocType(textstringDataType, textareaDataType);

        // 2. Create submissions folder at root
        CreateSubmissionsFolder();
    ...
    private void CreateSubmissionDocType(IDataType textstringDataType, IDataType textareaDataType)
    {
    ...
    private void CreateSubmissionsFolder()
    {
        ...
        if (submissionDocType != null)
        {
            ...
            {
                new ContentTypeSort(submissionDocType.Id, 0) { Alias = submissionDocType.Alias }
            };

            _contentTypeService.Save(submissionDocType);
        }
    ...
    private void CreateContactFormPage()
    {
